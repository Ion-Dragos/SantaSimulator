...
public final class Constants {
    ...
    public static final Integer BABY_AGE_MARGIN = 5;
    public static final Integer KID_AGE_MARGIN = 12;
    public static final Integer TEEN_AGE_MARGIN = 18;
    public static final Double MIN = 9999999.0;
